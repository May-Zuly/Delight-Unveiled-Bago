              ...
              <Col xs={24} md={6}>
                <div className="footer-widget mb-4">
                  ...
                  <Paragraph className="footer-paragraph">
                    Pertaining to or involving deep, contemplative, or
                    reflective thought, often aimed at achieving mental clarity,
                    relaxation, or spiritual insight.
                  </Paragraph>
                  ...
                  <div>
                    ...
                    <List>
                      ...
                      <List.Item>
                        ...
                        <Link
                          href="mailto:info@millieyoga.com"
                          className="text"
                        >
                          info@millieyoga.com
                        </Link>
